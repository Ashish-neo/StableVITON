...
def build_args():
    ...
    parser.add_argument("--model_load_path", type=str, required=True, help="Path to the trained model checkpoint.")
    parser.add_argument("--batch_size", type=int, default=16, help="Batch size for data loading.")
    parser.add_argument("--data_root_dir", type=str, default="./DATA/zalando-hd-resized", help="Root directory of the dataset.")
    parser.add_argument("--repaint", action="store_true", help="Option to repaint images.")
    parser.add_argument("--unpair", action="store_true", help="Option to use unpaired data.")
    parser.add_argument("--save_dir", type=str, default="./samples", help="Directory to save output samples.")
    parser.add_argument("--denoise_steps", type=int, default=50, help="Number of denoising steps.")
    ...
    parser.add_argument("--eta", type=float, default=0.0, help="Denoising eta parameter.")
...
def main(args):
    ...
    dataset_class = getattr(import_module("dataset1"), "CustomDataset")  # Ensure this matches your class name
